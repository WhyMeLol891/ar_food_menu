...
if (@move_uploaded_file($file['tmp_name'], $targetPath) && is_file($targetPath) && filesize($targetPath) > 0) { json_response(['ok' => true, 'message' => 'Tracking target installed and saved', 'size' => filesize($targetPath)]); }
